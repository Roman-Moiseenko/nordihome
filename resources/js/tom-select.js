...
!function (e, t) {
    ...
    const X = e => null == e ? null : Y(e), Y = e => "boolean" == typeof e ? e ? "1" : "0" : e + "",
        ...
        }, re = e => e.replace(/[\\"']/g, "\\$&"), le = (e, t) => {
            t && e.append(t)
        }

    function ae(e, t) {
        var i = Object.assign({}, W, t), s = i.dataAttr, n = i.labelField, o = i.valueField, r = i.disabledField,
    ...
    class de extends (function (e) {
        ...
        constructor(e, t) {
            ...
            const r = j("<div>"), l = j("<div>"), a = this._render("dropdown"),
                c = j('<div role="listbox" tabindex="-1">'), d = this.input.getAttribute("class") || "", u = n.mode
            var p
        ...
        setup() {
            ...
            (null === t.maxItems || t.maxItems > 1) && e.is_select_tag && Q(a, {multiple: "multiple"}), t.placeholder && Q(i, {placeholder: t.placeholder}), !t.splitOn && t.delimiter && (t.splitOn = new RegExp("\\s*" + r(t.delimiter) + "+\\s*")), t.load && t.loadThrottle && (t.load = ee(t.load, t.loadThrottle)), se(s, "mousemove", (() => {
                e.ignoreHover = !1
            })), se(s, "mouseenter", (t => {
        ...
        open() {
            var e = this
            e.isLocked || e.isOpen || "multi" === e.settings.mode && e.isFull() || (e.isOpen = !0, Q(e.focus_node, {"aria-expanded": "true"}), e.refreshState(), q(e.dropdown, {
                visibility: "hidden",
                display: "block"
        ...
        render(e, t) {
            ...
            if (s = j(s), "option" === e || "option_create" === e ? t[n.settings.disabledField] ? Q(s, {"aria-disabled": "true"}) : Q(s, {"data-selectable": ""}) : "optgroup" === e && (i = t.group[n.settings.optgroupValueField], Q(s, {"data-group": i}), t.group[n.settings.disabledField] && Q(s, {"data-disabled": ""})), "option" === e || "item" === e) {
                ...
                Q(s, {"data-value": i}), "item" === e ? (D(s, n.settings.itemClass), Q(s, {"data-ts-item": ""})) : (D(s, n.settings.optionClass), Q(s, {
                    role: "option",
                    id: t.$id
