...
function saveWidget() {
    router.visit(route('admin.page.widget.text.store' ), {
        method: "post",
        data: form,
        preserveScroll: true,
        preserveState: true,
...
function onToggle(row) {
    router.visit(route('admin.page.widget.text.toggle', {widget: row.id}), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function routeClick(row) {
   router.get(route('admin.page.widget.text.show', {widget: row.id}))
}

function handleDeleteEntity(row) {
    $delete_entity.show(route('admin.page.widget.text.destroy', {widget: row.id}));
}
</script>
