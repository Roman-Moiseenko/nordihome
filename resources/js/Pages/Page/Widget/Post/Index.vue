...
function saveWidget() {
    router.post(route('admin.page.widget.post.store' ), form)
}

function routeClick(row) {

   router.get(route('admin.page.widget.post.show', {widget: row.id}))
}

function onToggle(row) {
    router.visit(route('admin.page.widget.post.toggle', {widget: row.id}), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function handleDeleteEntity(row) {
    $delete_entity.show(route('admin.page.widget.post.destroy', {widget: row.id}));
}
</script>
