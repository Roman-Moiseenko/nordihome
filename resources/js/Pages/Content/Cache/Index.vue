...
function onClear() {
    router.visit(route('admin.content.cache.clear'), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function onCreate() {
    router.visit(route('admin.content.cache.create'), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function onCategories() {
    router.visit(route('admin.content.cache.categories'), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function onProducts() {
    router.visit(route('admin.content.cache.products'), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function onPages() {
    router.visit(route('admin.content.cache.pages'), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function onRemove(row) {
    router.visit(route('admin.content.cache.remove'), {
        method: "post",
        data: {name: row.name,},
        preserveScroll: true,
        preserveState: false,
