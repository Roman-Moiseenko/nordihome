...
function saveWidget() {
    router.post(route('admin.content.widget.banner.store' ), form)
}

function routeClick(row) {

   router.get(route('admin.content.widget.banner.show', {widget: row.id}))
}

function onToggle(row) {
    router.visit(route('admin.content.widget.banner.toggle', {widget: row.id}), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function handleDeleteEntity(row) {
    $delete_entity.show(route('admin.content.widget.banner.destroy', {widget: row.id}));
}
</script>
