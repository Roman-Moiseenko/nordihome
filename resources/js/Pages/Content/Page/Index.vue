...
function savePage() {
    router.visit(route('admin.content.page.store'), {
        method: "post",
        data: form,
        preserveScroll: true,
        preserveState: true,
...
function onToggle(row) {
    router.visit(route('admin.content.page.toggle', {page: row.id}), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
    })
...
function routeClick(row) {
    router.get(route('admin.content.page.show', {page: row.id}))
}
function onUp(row) {
    router.visit(route('admin.content.page.up', {page: row.id}), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
        onSuccess: page => {
...
function onDown(row) {
    router.visit(route('admin.content.page.down', {page: row.id}), {
        method: "post",
        preserveScroll: true,
        preserveState: false,
        onSuccess: page => {
...
function handleDeleteEntity(row) {
    $delete_entity.show(route('admin.content.page.destroy', {page: row.id}));
}
</script>
