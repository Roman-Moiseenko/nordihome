        ...
        <el-row :gutter="10" class="mt-2">
            ...
            <el-col :span="6">
                <div v-if="!product.modification" class=" text-sm">
                    ...
                    <Link type="primary"
                       :href="route('admin.catalog.modification.index')">Модификации</Link>
                </div>
                <div v-else>
                    <span class="font-medium">{{ product.modification.name }}</span>
            ...
            <!-- Колонка 2 -->
            <el-col :span="18" v-if="product.modification">
                    ...
                    <span class="font-medium ml-2">
                        <Link
                            :type="product.modification.base_product_id === prod.id ? 'danger' : 'primary'"
                              :href="route('admin.catalog.product.edit', prod.id)">
                            {{ prod.name }}
                        </Link>
                    </span>
                    <div class="ml-auto">
