<template>
    <el-tab-pane>
        ...
        <el-upload
            ...
            :action="route('admin.catalog.product.image.add', {product: props.product.id})"
...
const handleRemove: UploadProps['onRemove'] = (uploadFile) => {
    $delete_entity.show(
        route('admin.catalog.product.image.del', {product: props.product.id, photo_id: uploadFile.id}),
        {
            name: 'product_photo',
            state: true
        }
...
function onSubmit() {
    ...
    router.post(route('admin.catalog.product.image.set', {product: props.product.id}), form);
}
...
function initDragSort() {
    ...
    Sortable.create(el, {
        onEnd: ({ oldIndex, newIndex }) => {
            ...
            router.post(route('admin.catalog.product.image.move', {product: props.product.id}), {new_sort: new_sort})
        }
    });
}
