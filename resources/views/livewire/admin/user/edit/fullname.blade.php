<div>
    <div class="flex items-center mr-2" @if(!$change) style="display: none" @endif>
        <input class="form-control" wire:model="surname" autocomplete="off" placeholder="Фамилия">
        <input class="form-control" wire:model="firstname" autocomplete="off" placeholder="Имя">
        <input class="form-control" wire:model="secondname" autocomplete="off" placeholder="Отчество">
