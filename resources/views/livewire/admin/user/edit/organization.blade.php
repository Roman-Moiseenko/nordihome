<div>
    <div class="flex items-center mr-2" @if(!$change) style="display: none" @endif>
        <input class="form-control" wire:model="inn" autocomplete="off" placeholder="ИНН" wire:change="find_inn">
        <input class="form-control" wire:model="bik" autocomplete="off" placeholder="БИК">
        <input class="form-control" wire:model="pay_account" autocomplete="off" placeholder="р/счет">
    ...
    <div class="flex items-center" @if($change) style="display: none" @endif>
        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-lucide="landmark" class="lucide lucide-landmark stroke-1.5 w-4 h-4"><line x1="3" x2="21" y1="22" y2="22"></line><line x1="6" x2="6" y1="18" y2="11"></line><line x1="10" x2="10" y1="18" y2="11"></line><line x1="14" x2="14" y1="18" y2="11"></line><line x1="18" x2="18" y1="18" y2="11"></line><polygon points="12 2 20 7 4 7"></polygon></svg>
        <a class="ml-2 font-medium text-success" href="{{ $route }}">{{ $name }}</a>
        @if($edit)
