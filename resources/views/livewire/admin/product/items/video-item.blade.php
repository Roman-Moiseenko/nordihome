<div>
    <div class="relative pl-5 pr-5 xl:pr-10 py-10 bg-slate-200 rounded-md mt-3">
        <button type="button" class="text-slate-300 absolute top-0 right-0 mr-4 mt-4" wire:click="remove">
        ...
        <textarea class="form-control sm:mr-2 mt-3" rows="4"
