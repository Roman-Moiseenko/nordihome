    ...
    <div class="container-xl">
        <div class="row justify-content-between">
            <div class="col-12 col-md-12 col-lg-5">
                <div class="heading f-w_600 f-z_23 m-b_20">НОРДИ ХОУМ (NORDI HOME)</div>
                <div class="f-z_13">
                    <div>
                        <p>Магазин НОРДИ ХОУМ (NORDI HOME) занимается продажей и доставкой мебели ИКЕА из Европы под ключ для вашего удобства.</p>
                        <div>
