        ...
        <div class="col-md-6 col-lg-6">
            <div class="item-advantages">
                <div>
                    ...
                    <svg fill="#ffffff" height="100px" width="100px" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" viewBox="-92.45 -92.45 449.05 449.05" xml:space="preserve" stroke="#ffffff" stroke-width="0.0026414800000000003">
                ...
                <div class="heading">Прозрачные условия<br>работы</div>
                <div class="text">Работаем по договору, со всеми документами.</div>
            </div>
        </div>
        <div class="col-md-6 col-lg-6">
            <div class="item-advantages">
                <div><svg fill="#ffffff" width="100px" height="100px" viewBox="-11.2 -11.2 54.40 54.40" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" stroke-width="0.00032">
                ...
                <div class="heading">Огромный выбор товаров<br>в наличии</div>
                <div class="text">Более 900 моделей: от мебели до посуды и декора.</div>
            </div>
        </div>
        <div class="col-md-6 col-lg-6">
            <div class="item-advantages">
                <div><svg width="100px" height="100px" viewBox="-16.8 -16.8 81.60 81.60" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff" stroke-width="0.00048000000000000007">
                ...
                <div class="heading">Быстрая<br>доставка</div>
                <div class="text">Доставим ваши товары в срок в любое удобное для вас время.</div>
            </div>
        </div>
        <div class="col-md-6 col-lg-6">
            <div class="item-advantages">
                <div><svg width="100px" height="100px" viewBox="-5.6 -5.6 27.20 27.20" xmlns="http://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff" stroke-width="0.00016">
                ...
                <div class="heading">Доставка товаров<br>любого веса</div>
                <div class="text">Привезем Ваш заказ не зависимо от веса и объёма, чем больше вес заказа, тем выгоднее доставка. Всего от 60 рублей за килограмм!</div>
            </div>
        </div>
    </div>
</div>
