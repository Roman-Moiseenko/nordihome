                        ...
                        <div>
                            @if($item->slug=='svg01-item-advantages')
                                <svg fill="#ffffff" height="100px" width="100px" version="1.1" id="Layer_1"
                                     ...
                                     viewBox="-92.45 -92.45 449.05 449.05" xml:space="preserve" stroke="#ffffff"
                                     stroke-width="0.0026414800000000003">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0">
                                        <rect x="-92.45" y="-92.45" width="449.05" height="449.05" rx="224.525"
                                              fill="#0088cc" strokewidth="0"></rect>
                                    </g>
                            ...
                            @if($item->slug=='svg02-item-advantages')
                                <svg fill="#ffffff" width="100px" height="100px" viewBox="-11.2 -11.2 54.40 54.40"
                                     xmlns="https://www.w3.org/2000/svg" stroke="#ffffff" stroke-width="0.00032">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0">
                                        <rect x="-11.2" y="-11.2" width="54.40" height="54.40" rx="27.2" fill="#0088cc"
                                              strokewidth="0"></rect>
                                    </g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier"><title></title>
                                        <g data-name="Layer 2" id="Layer_2">
                                            <path
                                                d="M30,18H24a1,1,0,0,0-1,1v1H9V19a1,1,0,0,0-1-1H2a1,1,0,0,0-1,1V30a1,1,0,0,0,1,1H30a1,1,0,0,0,1-1V19A1,1,0,0,0,30,18Zm-7,4v4H9V22ZM3,20H7v9H3Zm6,8H23v1H9Zm20,1H25V20h4Z"></path>
                                            <path
                                                d="M28,17a1,1,0,0,0,1-1V4a1,1,0,0,0-1-1H4.13a1,1,0,0,0-1,1V16a1,1,0,0,0,1,1ZM5.13,5H27V15H5.13Z"></path>
                            ...
                            @if($item->slug=='svg03-item-advantages')
                                <svg width="100px" height="100px" viewBox="-16.8 -16.8 81.60 81.60"
                                     xmlns="https://www.w3.org/2000/svg" fill="#ffffff" stroke="#ffffff"
                                     stroke-width="0.00048000000000000007">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0">
                                        <rect x="-16.8" y="-16.8" width="81.60" height="81.60" rx="40.8" fill="#0088cc"
                                              strokewidth="0"></rect>
                                    </g>
                                    <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round"></g>
                                    <g id="SVGRepo_iconCarrier">
                                        <g id="Layer_2" data-name="Layer 2">
                                            ...
                                            <g id="Health_Icons" data-name="Health Icons">
                                                <g>
                                                    ...
                                                    <path
                                                        d="M15,19a2,2,0,0,0-2-2H5a2,2,0,0,0,0,4h8A2,2,0,0,0,15,19Z"></path>
