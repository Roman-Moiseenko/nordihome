                ...
                <div class="item-step t-a_center">
					...
					<g id="SVGRepo_bgCarrier" stroke-width="0">
                        ...
                        @if($item->slug=='svg02-item-step')
                                <svg fill="#ffffff" width="100px" height="100px" viewBox="-10.88 -10.88 53.76 53.76" version="1.1" xmlns="https://www.w3.org/2000/svg" stroke="#ffffff" stroke-width="0.00032">
                        ...
                        @if($item->slug=='svg03-item-step')
                                <svg width="100px" height="100px" viewBox="-348.16 -348.16 1720.32 1720.32" fill="#ffffff" class="icon" version="1.1" xmlns="https://www.w3.org/2000/svg" stroke="#ffffff" transform="matrix(1, 0, 0, 1, 0, 0)">
                                    <g id="SVGRepo_bgCarrier" stroke-width="0">
