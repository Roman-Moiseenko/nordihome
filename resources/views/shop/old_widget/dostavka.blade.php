...
<div class="container-xl mt-5">
    <h2 class="page-h2">Заказ и доставка</h2>
    <div class="row justify-content-center">
        <div class="col-md-6">
            <div class="item-advantages">
                <div><svg fill="#ffffff" width="100px" height="100px" viewBox="-41.78 -41.78 206.44 206.44" version="1.1" id="Layer_1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" style="enable-background:new 0 0 122.88 102.18" xml:space="preserve" stroke="#ffffff" transform="rotate(0)" stroke-width="0.0012288">
                ...
                <div class="heading">Первый шаг</div>
                <div class="text">Выбираете понравившийся вам товар с каталога <a href="https://www.ikea.com/pl/pl/" target="_blank" rel="nofollow">Икеа</a>.</div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="item-advantages">
                <div><svg fill="#ffffff" width="100px" height="100px" viewBox="-10.88 -10.88 53.76 53.76" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" stroke-width="0.00032">

                        <g id="SVGRepo_bgCarrier" stroke-width="0" transform="translate(0,0), scale(1)">

                            <rect x="-10.88" y="-10.88" width="53.76" height="53.76" rx="26.88" fill="#D7B56D" strokewidth="0"></rect>

                        </g>

                        <g id="SVGRepo_tracerCarrier" stroke-linecap="round" stroke-linejoin="round" stroke="#CCCCCC" stroke-width="0.064"></g>

                        <g id="SVGRepo_iconCarrier"> <path d="M30-0.003h-28c-1.099 0-2 0.9-2 2v28.006c0 1.099 0.9 2 2 2h28c1.099 0 2-0.901 2-2v-28.006c0-1.099-0.901-2-2-2zM30 30.003h-28v-28.006h28v28.006zM7 11.010h2v2c0 0.552 0.448 1 1 1s1-0.448 1-1v-2h2c0.552 0 1-0.448 1-1s-0.448-1-1-1h-2v-2c0-0.552-0.448-1-1-1s-1 0.448-1 1v2h-2c-0.552 0-1 0.448-1 1s0.448 1 1 1zM13.536 18.474c-0.39-0.39-1.024-0.391-1.414-0l-2.122 2.121-2.122-2.121c-0.391-0.39-1.024-0.39-1.415 0s-0.391 1.024 0 1.415l2.121 2.121-2.121 2.121c-0.391 0.39-0.391 1.024 0 1.415s1.024 0.39 1.415 0l2.122-2.12 2.122 2.121c0.39 0.39 1.024 0.39 1.414 0s0.39-1.024 0-1.415l-2.121-2.121 2.121-2.121c0.39-0.391 0.39-1.024 0-1.415zM19 11.009h6c0.552 0 1-0.448 1-1s-0.448-1-1-1h-6c-0.552 0-1 0.448-1 1s0.448 1 1 1zM19 21.009h6c0.552 0 1-0.448 1-1s-0.448-1-1-1h-6c-0.552 0-1 0.448-1 1s0.448 1 1 1zM19 25.009h6c0.552 0 1-0.448 1-1s-0.448-1-1-1h-6c-0.552 0-1 0.448-1 1s0.448 1 1 1z"></path> </g>

                    </svg></div>
                <div class="heading">Второй шаг</div>
                <div class="text"><p>Копируете артикул нужных позиций и наш <a href="/calculate/">калькулятор расчета стоимости</a> сам производит все расчеты по стоимости доставки.</p>
                    <p><b>*Чем больше вес заказа, тем дешевле стоимость доставки. Всего от 60 рублей за килограмм!</b></p></div>
            </div>
        </div>
        <div class="col-md-6">
            <div class="item-advantages">
                <div><svg width="100px" height="100px" viewBox="-348.16 -348.16 1720.32 1720.32" fill="#ffffff" class="icon" version="1.1" xmlns="http://www.w3.org/2000/svg" stroke="#ffffff" transform="matrix(1, 0, 0, 1, 0, 0)">

                        <g id="SVGRepo_bgCarrier" stroke-width="0">

                            <rect x="-348.16" y="-348.16" width="1720.32" height="1720.32" rx="860.16" fill="#D7B56D" strokewidth="0"></rect>
                ...
                <div class="heading">Третий шаг</div>
                <div class="text"><p>Оформляете заказ. Оплата 100% на банковский счет организации по договору.</p><p>Предоставляем кассовый чек об оплате с товарами и услугами.</p><p><b>*Срок доставки от 10 дней</b></p></div>
            </div>
        </div>
    </div>
</div>
