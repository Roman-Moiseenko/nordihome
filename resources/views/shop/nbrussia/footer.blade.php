                ...
                <div class="description mt-3">
                    <div>
                        <p>Магазин NB RUSSIA занимается продажей и доставкой одежды и обуви бренда New Balance из
                            Европы.</p>
                        <b>На текущий момент заявки не принимаем, сайт носит информационный характер</b>
                    </div>
                    <div>
                        <div>
                    ...
                    <p>Предоставляемая информация носит информационный характер. Не является публичной офертой,
                        определяемой положениями статьи 437 ГК РФ. Все права на публикуемые здесь материалы принадлежат</p>
                </div>
            </div>
        </div>
    </div>
