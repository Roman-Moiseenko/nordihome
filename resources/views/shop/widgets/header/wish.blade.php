<div id="wish-header" class="dropdown" style="position: relative">
    ...
    @auth('user')
        @if(count($user->wishes) > 0)
        <div id="wish-block" class="dropdown-menu menu-widget-popup" aria-labelledby="dropdown-wish">
                ...
                <div class="wish-body">
                    <div id="wish-item-template" class="wish-item" style="display: none">
                        ...
                        <div class="wish-item-trash"><a class="remove-item-wish" href="#" data-item="" data-route=""><i class="fa-light fa-trash"></i></a></div>
                    </div>
                </div>
            </div>
            @endif
