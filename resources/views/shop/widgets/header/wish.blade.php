<div id="wish-header" class="dropdown" style="position: relative">
    ...
    <div class="dropdown-menu menu-widget-popup" aria-labelledby="dropdown-wish">
            ...
            <div class="wish-body">
                <div id="wish-item-template" class="wish-item" style="display: none">
                    ...
                    <div class="wish-item-trash"><a class="remove-item-wish" href="#" data-item="" data-route=""><i class="fa-light fa-heart-circle-xmark"></i></a></div>
                </div>
            </div>
        </div>
