    ...
    <div class="box px-5 pt-5 mt-5">
        ...
        <div class="flex flex-col lg:flex-row border-b border-slate-200/60 dark:border-darkmode-400 pb-5 -mx-5">
                ...
                <div class="flex flex-col justify-center items-center lg:items-start mt-4">
                    <div class="truncate sm:whitespace-normal flex items-center">
                        <x-base.lucide class="w-4 h-4"
                                       icon="folder-open"/>&nbsp;{{ $widget->name }}
                    </div>
                    <div class="truncate sm:whitespace-normal flex items-center mt-3">
                        <x-base.lucide class="w-4 h-4" icon="package"/>&nbsp;{{ $widget->getObject() . ' - ' . $widget->getName() }}
                    </div>

                    <div class="truncate sm:whitespace-normal flex items-center mt-3">
                        <x-base.lucide class="w-4 h-4" icon="file-code-2"/>&nbsp;{{ $widget->templateName() . ' (' . $widget->template . ')' }}
                    </div>
            ...
            <div
                ...
                Статистические данные о виджете<br>
