<x-base.table.tr>
    ...
    <x-base.table.td class="text-center">{{ $item['order'] }}</x-base.table.td>
    <x-base.table.td class="text-center">{{ $item['user'] }}</x-base.table.td>
    <x-base.table.td class="text-center">{{ $item['document'] }}</x-base.table.td>
