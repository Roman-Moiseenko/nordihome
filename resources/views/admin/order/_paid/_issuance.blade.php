<input id="route" type="hidden" value="{{ route('admin.order.expense-calculate', $order) }}">
...
@foreach($order->items as $i => $item)
    <livewire:admin.order.paid.item :item="$item" :i="$i" :storages="$storages" />
@endforeach
...
@foreach($order->additions as $i => $addition)
    <livewire:admin.order.paid.addition :addition="$addition" :i="$i" />
@endforeach
...
<div class="box flex items-center font-semibold mt-3 p-2">
    ...
    <div>
        <button id="button-expense" class="btn btn-primary ml-2 mr-2" type="button"
                data-route="{{ route('admin.order.expense.create') }}" data-storage="{{ $mainStorage->id }}"
            ...
            <x-base.popover.panel>
                <div class="p-2">
                    ...
                    <div class="flex items-center mt-3">
                        ...
                        <button id="create-issue-shop" class="w-32 ml-2 btn btn-primary" type="button" data-route="{{ route('admin.order.expense.issue-shop') }}">
                            Выдать
                        </button>
                    </div>
                </div>
            ...
            <x-base.popover.panel>
                <div class="p-2">
                    ...
                    <div class="flex items-center mt-3">
                        ...
                        <button id="create-issue" class="w-32 ml-2 btn btn-primary" type="button" data-route="{{ route('admin.order.expense.issue-warehouse') }}">
                            Выдать
                        </button>
                    </div>
                </div>
