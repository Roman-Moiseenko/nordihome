<x-base.table.tr>
    <x-base.table.td class="w-40"><a href="{{ route('admin.pages.widget.show', $widget) }}"
    ...
    <x-base.table.td class="table-report__action w-56">
        <div class="flex justify-center items-center">
            <a class="flex items-center mr-3" href="{{ route('admin.pages.widget.edit', $widget) }}">
                <x-base.lucide icon="check-square" class="w-4 h-4"/>
                Edit </a>
            <a class="flex items-center text-danger" href="#"
               data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal" data-route = {{ route('admin.pages.widget.destroy', $widget) }}
