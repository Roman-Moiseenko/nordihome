            ...
            <div class="p-5">
                <div class="grid grid-cols-12 gap-2">
                    <div class="col-span-12 lg:col-span-6">
                        {{ \App\Forms\Input::create('name', ['placeholder' => 'Название', 'value' => $currency->name ?? '', 'class' => 'mt-5'])->show() }}
                        {{ \App\Forms\Input::create('sign', ['placeholder' => 'Обозначение', 'value' => $currency->sign ?? '', 'class' => 'mt-5'])->show() }}
                        {{ \App\Forms\Input::create('exchange', ['placeholder' => 'Курс', 'value' => $currency->exchange ?? '', 'class' => 'mt-5'])->show() }}
                    </div>
                    <div class="col-span-12 lg:col-span-6">
