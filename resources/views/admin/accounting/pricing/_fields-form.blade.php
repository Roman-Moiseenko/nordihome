            ...
            <div class="p-5">
                <div class="grid grid-cols-12 gap-2">
                    <div class="col-span-12 lg:col-span-6">
                        {{ \App\Forms\Input::create('number', ['placeholder' => 'Номер', 'value' => $pricing->number ?? '', 'class' => 'mt-5'])->show() }}

                        {{ \App\Forms\Input::create('comment', ['placeholder' => 'Комментарий', 'value' => $pricing->comment ?? '', 'class' => 'mt-3'])->label('Комментарий')->show() }}
                    </div>
                    <div class="col-span-12 lg:col-span-6">
