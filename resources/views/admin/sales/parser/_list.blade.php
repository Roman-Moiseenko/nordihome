<x-base.table.tr>
    <x-base.table.td class="w-52 font-medium"><a href="{{ route('admin.sales.preorder.show', $order) }}">{{ $order->htmlNum() }}</a></x-base.table.td>
    ...
    <x-base.table.td class="table-report__action w-56">
        <div class="flex justify-center items-center">
            <a class="flex items-center mr-3" href="{{ route('admin.sales.preorder.show', $order) }}">
                <x-base.lucide icon="check-square" class="w-4 h-4"/>
                Edit </a>
            <a class="flex items-center text-danger" href="#"
               data-tw-toggle="modal" data-tw-target="#delete-confirmation-modal" data-route = {{ route('admin.sales.preorder.destroy', $order) }}
