<x-base.table.tr>
    <x-base.table.td class="w-52 font-medium"><a href="{{ route('admin.sales.order.show', $order) }}">{{ $order->htmlNum() }}</a></x-base.table.td>
    ...
    <x-base.table.td class="text-center">{{ price($order->discount) }}</x-base.table.td>
    <x-base.table.td class="text-center">{{ price($order->coupon) }}</x-base.table.td>
