<x-base.table.tr>
    ...
    <x-base.table.td class="text-center">{{ $payment->order->user->fullname->getFullName() }}</x-base.table.td>
    <x-base.table.td class="text-center font-medium">{{ $payment->staff->fullname->getFullName() }}</x-base.table.td>
    <x-base.table.td class="table-report__action w-56">
        <div class="flex justify-center items-center">
            <a class="flex items-center mr-3" href="{{ route('admin.sales.payment.show', $payment) }}">
