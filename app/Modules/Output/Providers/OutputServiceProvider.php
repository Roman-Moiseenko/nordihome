...
namespace App\Modules\Output\Providers;

use App\Modules\Output\Database\Seeders\OutputRoleSeeder;
use App\Modules\Output\Domain\Interfaces\FeedRepositoryInterface;
use App\Modules\Output\Infrastructure\Persistence\FeedRepository;
...
/**
 * Service Provider for Output module
 *
 ...
 *
 * @package App\Modules\Output\Providers
...
class OutputServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $basePath = 'Modules/Output';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Output';

    /**
     * Namespace used for views and translations
     */
    protected string $scopeNamespace = 'output';
