...
class AttachTagsToProductUseCaseTest extends TestCase
{
    use MockPermission;

    private TagProductRepositoryInterface $repository;
    private AttachTagsToProductUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new AttachTagsToProductUseCase($this->repository);
    }
    ...
    {
        $this->repository->shouldReceive('attachTags')->with(5, [1, 2])->once();
    ...
    {
        $this->repository->shouldNotReceive('attachTags');
