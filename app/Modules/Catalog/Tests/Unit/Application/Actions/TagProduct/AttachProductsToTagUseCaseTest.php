...
use App\Modules\Catalog\Application\Actions\TagProduct\AttachProductsToTagUseCase;
...
class AttachProductsToTagUseCaseTest extends TestCase
{
    use MockPermission;

    private TagProductRepositoryInterface $repository;
    private AttachProductsToTagUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new AttachProductsToTagUseCase($this->repository);
    }
