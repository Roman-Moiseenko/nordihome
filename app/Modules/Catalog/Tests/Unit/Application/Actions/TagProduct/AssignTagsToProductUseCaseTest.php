...
use App\Modules\Catalog\Application\Actions\TagProduct\AssignTagsToProductUseCase;
...
class AssignTagsToProductUseCaseTest extends TestCase
{
    use MockPermission;

    private TagProductRepositoryInterface $repository;
    private AssignTagsToProductUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new AssignTagsToProductUseCase($this->repository);
    }
    ...
    {
        $this->repository->shouldReceive('syncTags')->with(5, [1, 2])->once();
    ...
    {
        $this->repository->shouldNotReceive('syncTags');
