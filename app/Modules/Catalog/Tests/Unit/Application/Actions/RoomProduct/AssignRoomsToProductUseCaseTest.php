...
class AssignRoomsToProductUseCaseTest extends TestCase
{
    use MockPermission;

    private RoomProductRepositoryInterface $repository;
    private AssignRoomsToProductUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new AssignRoomsToProductUseCase($this->repository);
    }
    ...
    {
        $this->repository->shouldReceive('syncRooms')->with(5, [1, 2])->once();
    ...
    {
        $this->repository->shouldNotReceive('syncRooms');
