...
class AttachProductsToRoomUseCaseTest extends TestCase
{
    use MockPermission;

    private RoomProductRepositoryInterface $repository;
    private AttachProductsToRoomUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new AttachProductsToRoomUseCase($this->repository);
    }
