...
class AssignProductsToCategoryUseCaseTest extends TestCase
{
    use MockPermission;

    private CategoryProductRepositoryInterface $repository;
    private AssignProductsToCategoryUseCase $useCase;
    ...
    protected function setUp(): void
    {
        ...
        $this->useCase = new AssignProductsToCategoryUseCase($this->repository);
    }
    ...
    #[Test]
    public function it_syncs_products_to_category(): void
    {
