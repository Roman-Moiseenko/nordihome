...
/*
Breadcrumbs::for('admin.catalog.group.create', function (BreadcrumbTrail $trail) {
    $trail->parent('admin.catalog.group.index');
    $trail->push('Добавить новую', route('admin.catalog.group.create'));
});*/
/*
Breadcrumbs::for('admin.catalog.group.edit', function (BreadcrumbTrail $trail, Group $group) {
    $trail->parent('admin.catalog.group.show', $group);
    $trail->push('Редактировать', route('admin.catalog.group.edit', $group));
});*/
