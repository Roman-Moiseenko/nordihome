...
use App\Modules\Notification\Infrastructure\Listeners\CreateNotificationsFromFormBack;
...
/**
 * Service Provider for Notification module
 *
 ...
 *
 * @package App\Modules\Notification\Providers
...
class NotificationServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $basePath = 'Modules/Notification';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Notification';

    /**
     * Namespace used for views and translations
     */
    protected string $scopeNamespace = 'notification';
    ...
    public function registerEvents()
    {
        Event::listen(
            LeadCollected::class,
            CreateNotificationsFromFormBack::class,
        );
