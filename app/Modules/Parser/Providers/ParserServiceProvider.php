...
/**
 * Service Provider for Parser module
 *
 ...
 *
 * @package App\Modules\Parser\Providers
...
class ParserServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $basePath = 'Modules/Parser';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Parser';

    /**
     * Namespace used for views and translations
     */
    protected string $scopeNamespace = 'parser';
    ...
    public function register()
    {
        ...
        $this->app->bind(
            ParserCategoryRepositoryInterface::class,
            ParserCategoryRepository::class
        );

        $this->app->bind(
            ParserProductRepositoryInterface::class,
            ParserProductRepository::class
        );
