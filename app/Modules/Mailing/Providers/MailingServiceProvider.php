...
namespace App\Modules\Mailing\Providers;
...
/**
 * Service Provider for Mailing module
 *
 ...
 *
 * @package App\Modules\Mailing\Providers
...
class MailingServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $basePath = 'Modules/Mailing';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Mailing';

    /**
     * Namespace used for views and translations
     */
    protected string $scopeNamespace = 'mailing';
    ...
    public function register()
    {
        ...
        $this->app->bind(
            \App\Modules\Shared\Application\Interfaces\Mail\MailServiceInterface::class,
            \App\Modules\Mailing\Infrastructure\Services\FakeMailService::class
        );
