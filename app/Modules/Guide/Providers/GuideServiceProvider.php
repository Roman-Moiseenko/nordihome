...
use App\Modules\Guide\Database\Seeders\CountrySeeder;
use App\Modules\Guide\Database\Seeders\GuideRoleSeeder;
use App\Modules\Guide\Database\Seeders\MarkingTypeSeeder;
use App\Modules\Guide\Database\Seeders\MeasuringSeeder;
use App\Modules\Guide\Database\Seeders\VATSeeder;
...
/**
 * Service Provider for Guide module
 *
 ...
 *
 * @package App\Modules\Guide\Providers
...
class GuideServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $basePath = 'Modules/Guide';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Guide';

    /**
     * Namespace used for views and translations
     */
    protected string $scopeNamespace = 'guide';
    ...
    public function register()
    {
        ...
        $this->app->bind(
            AdditionRepositoryInterface::class,
    ...
    public function registerSeeders()
    {
        ...
        $this->app->afterResolving('seed.handler', function ($handler) {
            $handler->register([
                ...
                MarkingTypeSeeder::class,
                MeasuringSeeder::class,
                VATSeeder::class,
            ]);
        });
    }
