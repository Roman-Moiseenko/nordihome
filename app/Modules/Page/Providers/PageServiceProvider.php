...
use App\Modules\Page\Database\Seeders\MetaSeeder;
use App\Modules\Page\Database\Seeders\PageRoleSeeder;
...
class PageServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $basePath = 'Modules/Page';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Page';
    ...
    public function register()
    {
        ...
        $this->app->bind(
            \App\Modules\Page\Application\Interfaces\MetaTemplateRepositoryInterface::class,
            \App\Modules\Page\Infrastructure\Persistence\MetaTemplateRepository::class,
        );
    }
