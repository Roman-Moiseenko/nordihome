...
/**
 * Service Provider for Cabinet module
 *
 ...
 *
 * @package App\Modules\Cabinet\Providers
...
class CabinetServiceProvider extends ServiceProvider
{
     ...
     * Module name
     */
    protected string $name = 'Cabinet';

    /**
     * Module base path within app/
     */
    protected string $basePath = 'Modules/Cabinet';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Cabinet';

    /**
     * Namespace used for views and translations
     */
    protected string $scopeNamespace = 'cabinet';
