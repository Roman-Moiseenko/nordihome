...
/**
 * Service Provider for Order module
 *
...
class OrderServiceProvider extends ServiceProvider
{
     ...
     */
    protected string $basePath = 'Modules/Order';

    /**
     * Module base namespace
     */
    protected string $baseNamespace = 'App\Modules\Order';

    /**
     * Namespace used for views and translations
     */
    protected string $scopeNamespace = 'order';
